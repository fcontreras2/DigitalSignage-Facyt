<?php
namespace DSFacyt\Core\Domain\Model\ValueObject;

/**
 * la clase slug genera un string que sirve como slug para identificar un objeto
 *
 * @author Freddy Contreras <freddycontreras3@gmai.com>
 * @author Currently Working: Freddy Contreras <freddycontreras3@gmai.com>
 * @version 03/09/2015
 */
class Slug 
{
